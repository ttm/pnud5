...
\begin{tabular}{| p{6cm} | c | c | c | c | }\hline
 descrição & script & RDF/XML & Turtle & diagramas ou listagens \\\hline
vocabulário do material de referência enviado pela SNAS  & \ref{i:1} & \ref{i:2} & \ref{i:3} & \ref{i:4},~\ref{i:4_1},~\ref{i:5} \\\hline
ontologia das conferências (Clovis) &~\ref{i:6}&~\ref{i:7}&~\ref{i:8}&~\ref{i:9},~\ref{i:10},~\ref{i:11} \\\hline
vocabulário das conferências (Clovis) &~\ref{i:12}&~\ref{i:13}&~\ref{i:14}&~\ref{i:16},~\ref{i:17},~\ref{i:18} \\\hline
